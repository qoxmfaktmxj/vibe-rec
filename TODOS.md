...
### [ ] TODO-11: [CRITICAL] 지원서 커스텀 질문 로드 실패 시 오류 게이트 추가
...
### [ ] TODO-12: [HIGH] homepage `getJobPostings()` empty vs error 상태 분리
...
### [ ] TODO-13: [HIGH] 공개 사이트 네비게이션 통일 (PublicSiteHeader)
...
### [ ] TODO-14: [HIGH] `PublicSiteHeader`의 `activePath` prop을 `usePathname()`으로 교체
...
### [ ] TODO-15: [MEDIUM] 상태 뱃지 색상 시스템 통일
...
### [ ] TODO-16: [MEDIUM] border-radius 사용 규칙 문서화 및 통일
...
### [ ] TODO-02: 지원 위저드 제출 완료 후 성공 화면 추가
...
### [ ] TODO-03: 로그인 후 `returnTo` 복귀 검증 및 수정
...
### [ ] TODO-05: 빈 상태(empty state) 디자인 개선
...
### [ ] TODO-06: 포커스 인디케이터 일관화 (WCAG 2.1 AA)
