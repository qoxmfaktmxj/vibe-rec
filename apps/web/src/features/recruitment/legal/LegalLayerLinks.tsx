...
const legalContent = {
  privacy: {
    ...
    sections: [
      {
        heading: "1. 처리 목적",
        body: "Vibe Rec은 채용 공고 조회, 지원서 접수, 문의 응대를 위해 필요한 최소한의 개인정보를 처리합니다.",
      },
      {
        heading: "2. 처리 항목",
        body: "지원자 정보(성명, 연락처, 이메일), 이력서·경력 등 채용 심사에 필요한 정보, 서비스 이용 과정에서 생성되는 접속 로그를 처리할 수 있습니다.",
      },
      {
        heading: "3. 보유 및 이용 기간",
        body: "채용 절차 종료 후 관련 법령 또는 내부 기준에 따라 필요한 기간 동안 보관하며, 보관 기간 경과 시 지체 없이 파기합니다.",
      },
      {
        heading: "4. 제3자 제공 및 처리위탁",
        body: "원칙적으로 정보주체 동의 또는 법령 근거 없이 제3자에게 제공하지 않으며, 위탁이 필요한 경우 수탁자와 위탁업무를 별도로 공개합니다.",
      },
      {
        heading: "5. 정보주체의 권리",
        body: "정보주체는 열람·정정·삭제·처리정지를 요청할 수 있으며, 요청은 문의 채널을 통해 접수할 수 있습니다.",
      },
      {
        heading: "6. 안전성 확보 조치",
        body: "접근권한 관리, 암호화, 로그 보관, 보안 점검 등 기술적·관리적 보호조치를 적용합니다.",
      },
      {
        heading: "7. 문의",
  ...
  terms: {
    ...
    sections: [
      {
        heading: "1. 목적",
        body: "본 약관은 Vibe Rec 서비스 이용과 관련한 회사와 이용자의 권리·의무 및 책임사항을 규정합니다.",
      },
      {
        heading: "2. 서비스 제공",
        body: "회사는 채용 공고 열람, 지원서 작성 및 제출, 관련 커뮤니케이션 기능을 제공합니다.",
      },
      {
        heading: "3. 회원 및 비회원의 의무",
        body: "이용자는 관계 법령, 본 약관, 서비스 안내사항을 준수해야 하며 타인의 권리를 침해하는 행위를 해서는 안 됩니다.",
      },
      {
        heading: "4. 게시물 및 저작권",
      ...
      {
        heading: "5. 면책",
        body: "회사는 천재지변, 불가항력, 이용자 귀책으로 인한 서비스 이용 장애에 대해 관련 법령 범위 내에서 책임을 제한할 수 있습니다.",
      },
      {
        heading: "6. 약관 변경",
        body: "약관을 변경하는 경우 시행일 및 변경 사유를 사전에 고지합니다.",
      },
      {
        heading: "7. 준거법 및 관할",
